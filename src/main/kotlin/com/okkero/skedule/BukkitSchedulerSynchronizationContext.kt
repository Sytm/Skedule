...
/**
 * Runs the given block with the provided synchronization context and reverts to the previous context after execution
 */
...
val CoroutineContext.synchronizationContext get() = get(BukkitSchedulerSynchronizationContext.Key)!!.sync
